    ...
    <table class="images" width="100%"  style="border:0px solid white; width:100%;">
        <tr style="border: 0px;">
            ...
            <td width="66%" style="border:0px; width:66.66% top:0 text-align:bottom">
              <h3>About Me</h3>
              <ul>
                <li><b>New Grad BS/MS</b> Student majoring in Computer Science and Engineering. Received <b>dual BS degree</b> in Computer Science and Engineering && Mathematics</li>
                <li>Have experience with <b>AI/ML</b>, <b>distributed systems</b>, <b>full-stack development</b>, and Internet of Things(IoT)</li>
